...
def createInstance(def Instanceid){
	sh """ sudo aws ec2 run-instances --image-id ami-0a4a70bd98c6d6441 --block-device-mappings file:///tmp/maping.json --count 1 --instance-type t2.medium --key-name atos --security-group-ids sg-cf6543ab --subnet-id subnet-4a020d22  > /tmp/instance.id """
	sh """ sleep 25"""
	sh '''  
